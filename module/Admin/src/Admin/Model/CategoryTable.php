...
class CategoryTable extends NestedTable{
   ...
   public function itemInselectBox($arrParam = null,$options = null){
      if($options['task'] == 'list-level'){
         ...
         $select     = $sqlObj->select()
                              ...
                              ->order('level DESC')
                              ->limit(1)
                              ->where('type = "'.$arrParam['type_category'].'"');
   ...
   public function listItem($arrParam = null,$options = null){
      ...
      if($options['task'] == 'list-items-paginator'){
         ...
         $select->where('menu.type = "'.$arrParam['type_category'].'"');
   ...
   public function saveItem($arrParam = null,$options = null){
      ...
      if($options['task']  == 'update-seo'){
         $data    =  array(
            'id'              => $arrParam['id'], 
            'seo_title'       => $arrParam['seo_title'],
            'seo_keyword'     => $arrParam['seo_keyword'],
            'seo_description' => $arrParam['seo_description'],
         );
