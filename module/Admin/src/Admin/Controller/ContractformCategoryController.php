...
class ContractformCategoryController extends ActionController
{
    ...
    {
        //Tiêu đề
        $title      =  'Quản lý danh mục biểu mẫu hợp đồng';   
    ...
    public function addAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục biểu mẫu hợp đồng > Thêm mới';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
        ...
        if($this->getRequest()->isPost()){
            ...
            if($niceHouseCategoryAdminForm->isValid() && empty($error)){
                    ...
                    $this->redirect()->toUrl('/admin/contractform-category/');
            }
        }
    ...
    public function editAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục biểu mẫu hợp đồng > Chỉnh sửa';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
