...
class NotifiController extends ActionController
{
    ...
    public function getTable(){
        if(empty($this->_modelTable)){
            $this->_modelTable = $this->getServiceLocator()->get('Admin\Model\NotifiTable');
        }
    ...
    public function addAction(){
        ...
        $websiteAdsAdminForm       = $this->serviceLocator->get('FormElementManager')->get('websiteAdsAdminForm');
        
        if($this->getRequest()->isPost()){
            $data = $this->getRequest()->getPost();
            $websiteAdsAdminForm->setData($data);


            if($websiteAdsAdminForm->isValid() && empty($error)){
                    ...
                    $this->redirect()->toUrl('/admin/website-ads/');
            }else{
                //echo '<pre>';
    ...
    public function editAction(){
        ...
        $notifiAdminForm       = $this->serviceLocator->get('FormElementManager')->get('notifiAdminForm');
        
        $notifiAdminForm->setInputFilter(new \Admin\Form\NotifiFilter(array('task'=>'edit', 'id'=>$this->_arrParam['id'])));
        $notifiAdminForm->bind($item);
        if($this->getRequest()->isPost()){
            $data   = $this->getRequest()->getPost();
            $notifiAdminForm->setData($data);

            
            if($notifiAdminForm->isValid() && empty($error)){
                ...
                $this->flashMessenger()->addSuccessMessage('Dữ liệu đã được lưu thành công');
                $this->redirect()->toUrl('/admin/notifi/');
            }else{
                //echo '<pre>';
