...
class RealestateCategoryController extends ActionController
{
    ...
    public function addAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục BĐS > Thêm mới';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
        ...
        if($this->getRequest()->isPost()){
            ...
            if($niceHouseCategoryAdminForm->isValid() && empty($error)){
                    ...
                    $this->redirect()->toUrl('/admin/realestate-category/');
            }
        }
    ...
    public function editAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục BĐS > Chỉnh sửa';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
