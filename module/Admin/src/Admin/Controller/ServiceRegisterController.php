...
class ServiceRegisterController extends ActionController
{
    ...
    public function getTable(){
        if(empty($this->_modelTable)){
            $this->_modelTable = $this->getServiceLocator()->get('Admin\Model\ServiceRegisterTable');
        }
    ...
    {
    	//Tiêu đề
    	$title      =  'Đăng kí Dịch vụ tài khoản cao cấp';   
    ...
    public function upgradeAction(){
        if(!empty($this->_arrParam['id'])){
            ...
            $this->getTable()->saveItem($arrParam,array('task'=>'upgrade'));
        ...
        $this->redirect()->toUrl('/admin/service-register/');    
