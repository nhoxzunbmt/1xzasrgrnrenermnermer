...
class BusinessTypeController extends ActionController
{
    ...
    {
        //Tiêu đề
        $title      =  'Quản lý Loại hình doanh nghiệp';   
    ...
    public function addAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý Loại hình doanh nghiệp > Thêm mới';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
        ...
        if($this->getRequest()->isPost()){
            ...
            if($niceHouseCategoryAdminForm->isValid() && empty($error)){
                    ...
                    $this->redirect()->toUrl('/admin/business-type/');
            }
        }
    ...
    public function editAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý Loại hình doanh nghiệp > Chỉnh sửa';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
