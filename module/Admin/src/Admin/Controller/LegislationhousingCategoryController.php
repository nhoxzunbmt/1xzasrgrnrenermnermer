...
class LegislationhousingCategoryController extends ActionController
{
    ...
    {
        //Tiêu đề
        $title      =  'Quản lý danh mục pháp lý nhà đất';   
    ...
    public function addAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục pháp lý nhà đất > Thêm mới';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
        ...
        if($this->getRequest()->isPost()){
            ...
            if($niceHouseCategoryAdminForm->isValid() && empty($error)){
                    ...
                    $this->redirect()->toUrl('/admin/legislationhousing-category/');
            }
        }
    ...
    public function editAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục pháp lý nhà đất > Chỉnh sửa';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
