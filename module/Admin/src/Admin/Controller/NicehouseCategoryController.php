...
class NicehouseCategoryController extends ActionController
{
    ...
    {
        //Tiêu đề
        $title      =  'Quản lý danh mục nhà đẹp';   
    ...
    public function addAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục nhà đẹp > Thêm mới';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
    ...
    public function editAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục nhà đẹp > Chỉnh sửa';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
