...
class GalleryController extends ActionController
{
    ...
    public function getTable(){
        if(empty($this->_newsTable)){
            $this->_newsTable = $this->getServiceLocator()->get('Admin\Model\GalleryTable');
        }
    ...
    public function indexAction()
    {
        ...
        if($this->getRequest()->isPost()){
            ...
            if(!empty($fileName)){
                $upload->addValidator('Extension', true, array('png','jpg','gif'), 'file' );
                ...
                if(!$upload->isValid('file')){
                    ...
                    //upload ảnh mới
                    $file = $upload->uploadFile('file', UPLOAD_PATH .'/gallery/', array('task' => 'rename'), 'batdongsan_');
                }
            }else{
