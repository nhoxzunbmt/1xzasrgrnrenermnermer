...
class WebsiteAdsController extends ActionController
{
    ...
    public function getTable(){
        if(empty($this->_modelTable)){
            $this->_modelTable = $this->getServiceLocator()->get('Admin\Model\WebsiteAdsTable');
        }
    ...
    public function addAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Liên kết website > Thêm mới';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
    ...
    public function editAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Liên kết website > Chỉnh sửa';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
        ...
        $websiteAdsAdminForm->setInputFilter(new \Admin\Form\WebsiteAdsFilter(array('task'=>'edit', 'id'=>$this->_arrParam['id'])));
        $websiteAdsAdminForm->bind($item);
        if($this->getRequest()->isPost()){
            $data   = $this->getRequest()->getPost();
            $websiteAdsAdminForm->setData($data);
