...
class FengshuiCategoryController extends ActionController
{
    ...
    {
        //Tiêu đề
        $title      =  'Quản lý danh mục phong thủy';   
    ...
    public function addAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục phong thủy > Thêm mới';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
        ...
        if($this->getRequest()->isPost()){
            ...
            if($niceHouseCategoryAdminForm->isValid() && empty($error)){
                    ...
                    $this->redirect()->toUrl('/admin/fengshui-category/');
            }
        }
    ...
    public function editAction(){
        $error          = array();
        //Tiêu đề
        $title          =  'Quản lý danh mục phong thủy > Chỉnh sửa';   
        $this->headTitle($title)->setSeparator(" - ")->append("Hệ thống quản trị website");
