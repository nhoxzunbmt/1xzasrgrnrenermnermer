<?php 
	...
	if($this->arrParam['action'] == 'logo'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/logo');
	}if($this->arrParam['action'] == 'footer'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/footer');
	}if($this->arrParam['action'] == 'banner'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/banner');
	}if($this->arrParam['action'] == 'background'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/background');
	}
	...
	switch ($this->arrParam['action']){
		...
		case 'logo' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;
		case 'footer' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;	

		case 'banner' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;
		case 'background' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;	
		default 		:	$strBtn = '';				  				  					  					  					  				
	}										
