...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'navfooter' : 	
										$strBtn =  '<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/nav-footer/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Quản lý menu (Footer)</a></li>'
										.$linkSkinBanner
										.$linkSkinLogo
										.$linkSkinFooter
										.$linkSkinBackground
