...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'businesstype' : $strBtn =  $linkProjectManager
								.$linkProjectCategory
								.$linkRealEstate
								.$linkRealEstateCat
								.$linkBusiness
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/business-type/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Loại hình doanh nghiệp</a></li>';
