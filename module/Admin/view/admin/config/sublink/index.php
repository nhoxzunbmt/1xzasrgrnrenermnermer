<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'config' : 	 
										$strBtn =  '<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/config/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Cấu hình chung</a></li>'
										.$linkSupport
										.$linkSites;
