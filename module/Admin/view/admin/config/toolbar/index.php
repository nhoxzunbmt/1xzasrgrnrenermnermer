<?php 
	...
	if($this->arrParam['action'] == 'index'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/index');
	}if($this->arrParam['action'] == 'company'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/company');
	}if($this->arrParam['action'] == 'map'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/map');
	}if($this->arrParam['action'] == 'email'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/email');
	}if($this->arrParam['action'] == 'advance'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/advance');
	}if($this->arrParam['action'] == 'display'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/display');
	}if($this->arrParam['action'] == 'maintenance'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/maintenance');
	}
	...
	switch ($this->arrParam['action']){
		...
		case 'index' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;
		case 'company' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;	

		case 'map' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;
		case 'email' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;
		case 'advance' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;	
		case 'display' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;	

		case 'maintenance' 	: 	$strBtn 	= $btnSaveItem ;
							$iconTitle 	= 'title-edit.png';
			break;								
		default 		:	$strBtn = '';				  				  					  					  					  				
	}										
