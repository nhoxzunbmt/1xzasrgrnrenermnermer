...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'realestate' : $strBtn = $linkProjectManager 
								.$linkProjectCategory
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/realestate/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Quản lý bất động sản</a></li>'
								.$linkRealEstateCat
								.$linkBusiness
								.$linkBusinessType;
