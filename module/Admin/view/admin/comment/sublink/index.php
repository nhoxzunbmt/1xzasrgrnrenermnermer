...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'comment' : $strBtn = $linkUserManager 
								...
								.$linkContactBusiness
								.$linkEmailRegister
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/comment/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Nhận xét</a></li>';
