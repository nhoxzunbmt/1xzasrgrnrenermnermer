...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'fengshuiapp' : $strBtn =  $linkNewsManager
										.$linkNewsCatManager
										.$linkNiceHouse
										.$linkNiceHouseCat
										.$linkFengshuiNews
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/fengshuiapp/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Ứng dụng phong thủy</a></li>'
