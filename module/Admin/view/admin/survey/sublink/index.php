...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'survey' : 	
										...
										.$linkGallery
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/survey/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Thăm dò ý kiến</a></li>'
										.$linkSlide;
