...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'legislationhousingcategory' : $strBtn =  
										$linklegalhousing
										.$linklegalhousingCat
										.$linklegislationhousing
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/legislationhousing-category/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Danh mục văn bản luật nhà đất</a></li>'
