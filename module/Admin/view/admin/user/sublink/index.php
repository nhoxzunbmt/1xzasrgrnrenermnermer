...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'user' : $strBtn = '<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/user/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Quản lý thành viên</a></li>'
