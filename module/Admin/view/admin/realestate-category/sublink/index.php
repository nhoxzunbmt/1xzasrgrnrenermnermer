...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'realestatecategory' : $strBtn = $linkProjectManager 
								.$linkProjectCategory
								.$linkRealEstate
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/realestate-category/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Loại bất động sản</a></li>'
								.$linkBusiness
								.$linkBusinessType;
