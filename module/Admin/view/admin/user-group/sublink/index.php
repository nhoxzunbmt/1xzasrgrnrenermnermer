...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'usergroup' : $strBtn = $linkUserManager 
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/user-group/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Quản lý nhóm thành viên</a></li>'
