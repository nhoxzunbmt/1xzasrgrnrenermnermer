...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'emailnewsletter' : $strBtn = $linkUserManager 
								...
								.$linkContactAgency
								.$linkContactBusiness
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/email-newsletter/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Email đăng kí</a></li>'
