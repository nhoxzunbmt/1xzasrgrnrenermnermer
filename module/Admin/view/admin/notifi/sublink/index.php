...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'notifi' : $strBtn =  $linkNewsManager
										.$linkNewsCatManager
										.$linkNiceHouse
										.$linkNiceHouseCat
										.$linkFengshuiNews 
										.$linkFengshuiApp 
										.$linkFengshuiCat
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/notifi/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Thông báo</a></li>';
