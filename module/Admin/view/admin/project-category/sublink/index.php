...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'projectcategory' : $strBtn = 	$linkProjectManager
										 	.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/project-category/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Danh mục dự án</a></li>'
											.$linkRealEstate
											.$linkRealEstateCat
											.$linkBusiness
											.$linkBusinessType;
