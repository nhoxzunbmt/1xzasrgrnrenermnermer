...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'ads' : $strBtn =  		$linkWebsiteAds
										.$linkSeoGoogle
										.$linkEmailMarketing
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/ads/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Quảng cáo trực tuyến</a></li>';
