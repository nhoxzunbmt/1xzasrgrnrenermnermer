...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'permission' : $strBtn = $linkUserManager 
								.$linkUserGroupManager
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/permission/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Phân quyền</a></li>'
