...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'nicehousecategory' : $strBtn =  $linkNewsManager
										.$linkNewsCatManager
										.$linkNiceHouse
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/nicehouse-category/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Danh mục nhà đẹp</a></li>'
										.$linkFengshuiNews 
										.$linkFengshuiApp 
										.$linkFengshuiCat
										.$linkNotifi;
