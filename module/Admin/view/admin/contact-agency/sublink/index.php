...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'contactagency' : $strBtn = $linkUserManager 
								.$linkUserGroupManager
								.$linkPermission
								.$linkContact
								.$linkContactRealEstate
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/contact-agency/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Liên hệ môi giới</a></li>'
