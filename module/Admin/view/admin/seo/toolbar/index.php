<?php 
	...
	switch ($this->arrParam['action']){
		case 'nicehouse-category'	: 	$strBtn 	= 	'';
		...
		case 'news-category'	: 	$strBtn 	= 	'';
			  				$iconTitle 	= 'list-index.png';	    		

			break;	

		case 'project-category'	: 	$strBtn 	= 	'';
			  				$iconTitle 	= 'list-index.png';	    		

			break;	

		case 'realestate-category'	: 	$strBtn 	= 	'';
			  				$iconTitle 	= 'list-index.png';	    		

			break;
		case 'business-category'	: 	$strBtn 	= 	'';
			  				$iconTitle 	= 'list-index.png';	    		

			break;	

		case 'legalhousing-category'	: 	$strBtn 	= 	'';
			  				$iconTitle 	= 'list-index.png';	    		

			break;
		case 'legislationhousing-category'	: 	$strBtn 	= 	'';
			  				$iconTitle 	= 'list-index.png';	    		

			break;	

		case 'contractform-category'	: 	$strBtn 	= 	'';
			  				$iconTitle 	= 'list-index.png';	    		

			break;	

		case 'fengshui-category'	: 	$strBtn 	= 	'';
			  				$iconTitle 	= 'list-index.png';	    		
