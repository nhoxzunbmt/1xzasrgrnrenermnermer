...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'seo' : $strBtn =  		$linkWebsiteAds
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/seo/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > SEO trên google</a></li>'
										.$linkEmailMarketing 
										.$linkAds;
