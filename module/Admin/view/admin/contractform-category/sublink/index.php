...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'contractformcategory' : $strBtn =  
										$linklegalhousing
										.$linklegalhousingCat
										.$linklegislationhousing
										.$linklegislationhousingCat
										.$linkcontractform 
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/contractform-category/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Danh mục biểu mẫu hợp đồng</a></li>';
