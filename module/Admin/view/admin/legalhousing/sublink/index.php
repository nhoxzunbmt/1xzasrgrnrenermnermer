...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'legalhousing' : $strBtn =  
										'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/legalhousing/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Pháp lý nhà đất</a></li>'
										.$linklegalhousingCat 
