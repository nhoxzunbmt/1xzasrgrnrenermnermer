...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'support' : 	 
										...
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/support/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Hỗ trợ trực tuyến</a></li>'
										.$linkSites;
