...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'legislationhousing' : $strBtn =  $linklegalhousing
										.$linklegalhousingCat
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/legislationhousing/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Văn bản luật nhà đất</a></li>'
