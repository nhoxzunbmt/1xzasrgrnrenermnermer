...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'contactrealestate' : $strBtn = $linkUserManager 
								.$linkUserGroupManager
								.$linkPermission
								.$linkContact
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/contact-realestate/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Liên hệ BĐS</a></li>'
