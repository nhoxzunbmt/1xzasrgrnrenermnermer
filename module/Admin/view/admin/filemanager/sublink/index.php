...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'filemanager' : 	
										$strBtn =  '<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/filemanager/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Quản lý file</a></li>'
										.$linkGallery
										.$linkPoll
										.$linkSlide;
