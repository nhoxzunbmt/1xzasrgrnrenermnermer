...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'emailmarketing' : $strBtn =  		$linkWebsiteAds
										.$linkSeoGoogle
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/emailmarketing/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Tiếp thị qua email</a></li>'
										.$linkAds;
