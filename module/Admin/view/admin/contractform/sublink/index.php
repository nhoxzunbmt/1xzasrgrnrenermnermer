...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'contractform' : $strBtn =  
										$linklegalhousing
										.$linklegalhousingCat
										.$linklegislationhousing
										.$linklegislationhousingCat
										
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/contractform/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Biểu mẫu hợp đồng</a></li>'
										.$linkcontractformCat;
