...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'newscategory' : $strBtn =  $linkNewsManager
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/news-category/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Danh mục tin tức BĐS</a></li>'
										.$linkNiceHouse
										.$linkNiceHouseCat
										.$linkFengshuiNews 
										.$linkFengshuiApp 
