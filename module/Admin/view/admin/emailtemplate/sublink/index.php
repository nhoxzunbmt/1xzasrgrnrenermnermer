...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'emailtemplate' : 	
										...
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/emailtemplate/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Template Email</a></li>';
