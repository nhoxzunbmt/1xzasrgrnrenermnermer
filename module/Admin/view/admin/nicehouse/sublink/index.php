...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'nicehouse' : $strBtn =  $linkNewsManager
										.$linkNewsCatManager
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/nicehouse/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Nhà đẹp</a></li>'
										.$linkNiceHouseCat
										.$linkFengshuiNews 
										.$linkFengshuiApp 
										.$linkFengshuiCat
