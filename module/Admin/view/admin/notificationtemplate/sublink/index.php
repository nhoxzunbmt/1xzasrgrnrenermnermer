...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'notificationtemplate' : 	
										...
										.$linkSkinFooter
										.$linkSkinBackground
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/notificationtemplate/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Template thông báo</a></li>'
										.$linkEmailtemplate;				
			  			break;
