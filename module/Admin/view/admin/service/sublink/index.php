...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'service' : $strBtn =  '<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/service/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Quản lý dịch vụ</a></li>'
								.$linkServiceRegister ;
