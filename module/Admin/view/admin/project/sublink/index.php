...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'project' : $strBtn =  '<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/project/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Quản lý dự án</a></li>'
								.$linkProjectCategory
								.$linkRealEstate
								.$linkRealEstateCat
								.$linkBusiness
