<?php 
	...
	}if($this->arrParam['action'] == 'list-district'){
		$linkAddNew  	= $this->basePath($this->currentController . '/add-district/' . $id);
	}if($this->arrParam['action'] == 'list-ward'){
		$linkAddNew  	= $this->basePath($this->currentController . '/add-ward/' . $id);
	}
	...
	}if($this->arrParam['action'] == 'add-district'){
		$linkSaveItem 	= $this->basePath($this->currentController . '/add-district/' . $id);
	}if($this->arrParam['action'] == 'add-ward'){
		$linkSaveItem 	= $this->basePath($this->currentController . '/add-ward/' . $id);
	}if($this->arrParam['action'] == 'edit-district'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/edit-district/' . $id);
	}if($this->arrParam['action'] == 'edit-ward'){
		 $linkSaveItem 	= $this->basePath($this->currentController . '/edit-ward/' . $id);
	...
	switch ($this->arrParam['action']){
		...
		case 'edit-district' 	: 	$strBtn 	= $btnSaveItem . ' ' . $btnCancel;
							$iconTitle 	= 'title-edit.png';
			break;	

		case 'edit-ward' 	: 	$strBtn 	= $btnSaveItem . ' ' . $btnCancel;
							$iconTitle 	= 'title-edit.png';
			break;			
		...
		case 'add-district' 		: 	$strBtn = $btnSaveItem . ' ' . $btnCancel;
							$iconTitle 	= 'document_add.png';
			break;	

		case 'add-ward' 		: 	$strBtn = $btnSaveItem . ' ' . $btnCancel;
							$iconTitle 	= 'document_add.png';
			break;			
