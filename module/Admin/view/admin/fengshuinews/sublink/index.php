...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'fengshuinews' : $strBtn =  $linkNewsManager
										.$linkNewsCatManager
										.$linkNiceHouse
										.$linkNiceHouseCat
										.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/fengshuinews/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Tin tức phong thủy</a></li>'
										.$linkFengshuiApp 
										.$linkFengshuiCat
										.$linkNotifi;
