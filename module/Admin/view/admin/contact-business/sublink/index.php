...
<?php 
	...
	switch ($this->arrParam['controller']){
		...
		case 'contactbusiness' : $strBtn = $linkUserManager 
								.$linkUserGroupManager
								.$linkPermission
								.$linkContact
								.$linkContactRealEstate
								.$linkContactAgency 
								.'<li class="Last"><a href="'.$this->basePath('/'.$this->arrParam['module'].'/contact-business/index').'"><img src="'.TEMPLATE_URL.'/admin/images/tablet_menu_icon.png" width="10px" > Liên hệ doanh nghiệp</a></li>'
