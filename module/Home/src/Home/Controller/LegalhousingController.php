...
class LegalhousingController extends ActionController
{
    ...
    public function getTable(){
        if(empty($this->_legalHousingTable)){
            $this->_legalHousingTable = $this->getServiceLocator()->get('Home\Model\LegalHousingTable');
        }
    ...
    public function indexAction(){
        ...
        //Tiêu đề
        $title                  =  'Pháp lý nhà đất - Cafe luật';   
    ...
    public function categoryAction()
    {
        ...
        $listItemsCategory      = $this->getTable()->listItem($this->_arrParam,array('task'=>'list-category')); 
        //info danh mục 
        $itemInfoCategory       = $this->getTable()->getItem($this->_arrParam,array('task'=>'get-item-cat'));
