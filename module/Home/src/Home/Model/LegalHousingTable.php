   ...
   public function listItem($arrParam = null,$options = null){
      ...
      if($options['task'] == 'list-category'){
         ...
         $select     = $sqlObj->select()
                              ...
                              ->where('type = "category_legalhousing"');
                              $select->order('id ASC');
      ...
      if($options['task'] == 'list-items-paginator'){
         ...
         $sqlObj     = new Sql($this->adapter);
         $select     = $sqlObj->select();
         $select->from(array('l'=>'legal_housing'))
               ->columns(array(
      ...
      if($options['task'] == 'block-cafe-luat'){
         $sqlObj     = new Sql($this->adapter);
         $select     = $sqlObj->select();
        $select->from(array('l'=>'legal_housing'))
               ->columns(array(
