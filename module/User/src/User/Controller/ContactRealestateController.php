...
class ContactRealestateController extends ActionController
{
    ...
    protected $_contactRealEstateTable;
  

    public function getTable(){
        if(empty($this->_contactRealEstateTable)){
            $this->_contactRealEstateTable = $this->getServiceLocator()->get('User\Model\ContactRealEstateTable');
        }
        return $this->_contactRealEstateTable;
    }
    ...
    {
        //Tiêu đề
        $title      =  'Khách hàng liên hệ tin Bất động sản';   
