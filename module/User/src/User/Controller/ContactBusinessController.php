...
class ContactBusinessController extends ActionController
{
    ...
    protected $_contactBusinessTable;
  

    public function getTable(){
        if(empty($this->_contactBusinessTable)){
            $this->_contactBusinessTable = $this->getServiceLocator()->get('User\Model\ContactBusinessTable');
        }
        return $this->_contactBusinessTable;
    }
    ...
    {
        //Tiêu đề
        $title      =  'Khách hàng liên hệ Doanh nghiệp';   
    ...
    public function viewAction()
    {
        ...
        //Tiêu đề
        $title      =  'Xem liên hệ Doanh nghiệp';   
    ...
    public function listAction(){
     ...
     public function deleteAction(){
        ...
        $this->redirect()->toUrl('/user/contact-realestate/index/');
