...
class ContactAgencyController extends ActionController
{
    ...
    protected $_contactAgencyTable;
  

    public function getTable(){
        if(empty($this->_contactAgencyTable)){
            $this->_contactAgencyTable = $this->getServiceLocator()->get('User\Model\ContactAgencyTable');
        }
        return $this->_contactAgencyTable;
    }
    ...
    {
        //Tiêu đề
        $title      =  'Khách hàng liên hệ Môi Giới';   
