<input name="txtLoaiTin" id="txtLoaiTin" value="1" type="hidden" /> <input
		name="txtTT" id="txtTT" type="hidden" value='0' /> <input
		name="txtQuan" id="txtQuan" type="hidden" value='0' /> <input
		name="txtKV" id="txtKV" type="hidden" value='0' />
<div class="dv-boxsearch-r">
	...
	<div class="content buy">
		<div class="in-tab">
			<p>
				<input name="ctl00$ContentPlaceHolder3$boxSearch1$txtTuKhoa"
					type="text" id="ContentPlaceHolder3_boxSearch1_txtTuKhoa"
					class="inputNewTimKiem" autocomplete="off"
					placeholder="Nhập địa điếm, vd: Mỹ đình, Topaz Garden" />
			</p>
			<div id="listTimKiem"
			...
			<p>
				<select name="ctl00$ContentPlaceHolder3$boxSearch1$ddlOrders"
					id="ContentPlaceHolder3_boxSearch1_ddlOrders">
				</select>
			</p>
			<p>
